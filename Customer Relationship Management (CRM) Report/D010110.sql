...
where t.right_u_c_e_p = 'สิทธิสวัสดิการพนักงานส่วนท้องถิ่น'
and $X{IN,nhz.name,zone_name}
and t.created_at between $P{start_date} and  $P{end_date} 

group by t.incidprovin
order by t.incidprovin